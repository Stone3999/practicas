...
class SensorSimulator {
  ...
  void _update() {
    ...
    if (!_stepsCtrl.isClosed) _stepsCtrl.add(_steps);
    if (!_heartRateCtrl.isClosed) _heartRateCtrl.add(_heartRate);
    if (!_caloriesCtrl.isClosed) _caloriesCtrl.add(_calories.toInt());
